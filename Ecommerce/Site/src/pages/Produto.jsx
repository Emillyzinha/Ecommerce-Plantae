...
function ProdutoEscolhido() {
    ...
    const [carrinhoAtual, setCarrinhoAtual] = useState(JSON.parse(localStorage.getItem('carrinhoProdutos')) || [])
    ...
    const navegarCarrinho = () => {
        ...
        if (novoItem) {
            let copiaCarrinho = [...carrinhoAtual]
            copiaCarrinho.push(informacoesPlanta)
            setCarrinhoAtual(copiaCarrinho)
            // localStorage.setItem('carrinhoProdutos', JSON.stringify(carrinhoAtual));
